...
export class AuthService {
    ...
    // use this subject to check whether user is authicated so that if hide login/register buttons in header
    ...
    // take username/password from login component and post it to API service that will post to API
    ...
    populateUserInfo() {
        //get the token from local storage and decode it and get the user info such as email, name etc. to show in the header
        ...
        if (token) {
            ...
            //pushing dta to the observables
