...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210713204313_UpdatingGenreTableNameRequired")]
    partial class UpdatingGenreTableNameRequired
    {
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieGenre", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Genre", "Genre")
                        .WithOne("MovieGenre")
                        .HasForeignKey("ApplicationCore.Entities.MovieGenre", "GenreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.Movie", "Movie")
                        .WithOne("MovieGenre")
                        .HasForeignKey("ApplicationCore.Entities.MovieGenre", "MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
